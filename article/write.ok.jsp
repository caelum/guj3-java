...
<c:set var="title">Cria&ccedil;&atilde; de artigos</c:set>
...
function validateForm(f) {
	if (f["article.title"].value == '') {
		alert("Por favor, preencha o título do artigo");
		return false;
	}
	
	if (f["article.subtitle"].value == '') {
		alert("Por favor, preencha o subtítulo do artigo");
		return false;
	}
...
<div class="articles box">
	...
	<div class="spiffyfg inner-content">
		<h2><a href="#">Cria&ccedil;&atilde;o de artigos</a></h2>
		<br><br>
	...
	<c:choose>
		...
		<c:otherwise>
			<form method="POST" action="<c:url value="/article.save.logic"/>" enctype="multipart/form-data" onSubmit="return validateForm(this);">
			...
			<br/>
			<div class="categoryHeader">Conteúdo do artigo</div>
